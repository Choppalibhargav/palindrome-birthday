function reverseString(str) {
  ...
  function getNextPalindromeDate(date) {
    ...
    while (1) {
      ctr++;
      var dateStr = convertDateAsString(nextDate);
  ...
  function getPreviousPalindromeDate(date) {
    ...
    while (1) {
      ctr++;
      var dateStr = convertDateAsString(previousDate);
      var resultList = checkPalindromeForAllDateFormats(dateStr);
  ...
  function clickHandler(e) {
    ...
    if (bdayString !== "") {
      ...
      var dateStr = convertDateAsString(date);
      ...
      if (!isPalindrome) {
        ...
        if (ctr1 > ctr2) {
          resultDiv.innerText = `sorry but the nearest palindrome date is ${prevDate.day}-${prevDate.month}-${prevDate.year}, you missed it by ${ctr2} days.😢😢`;
        } else {
          resultDiv.innerText = `sorry but he nearest palindrome date is ${nextDate.day}-${nextDate.month}-${nextDate.year}, you missed it by ${ctr1} days.😢😢`;
        }
      } else {
